...
TITLE_SETTINGS = f"{APPLICATION_NAME} Configuraciones"
TITLE_PINNED_OVERFLOW = f"{APPLICATION_NAME} Pinned Overflow"
TITLE_AI_PROMPT = f"{APPLICATION_NAME} AI Prompt"
