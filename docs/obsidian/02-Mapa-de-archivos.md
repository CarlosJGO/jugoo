...
| [`themes/`](../../themes/) | Temas TOML semánticos; `space.toml` es el predeterminado. |
...
| [`shell/style.css`](../../shell/style.css) | Necesitas selectores, layout CSS o estados visuales estructurales. No contiene la paleta. |
| [`shell/ui/theme.py`](../../shell/ui/theme.py) | Necesitas carga, validación, recarga o exportación de temas. |
...
- “El dato está bien pero se ve mal”: `themes/space.toml`, widget y `shell/style.css`.
